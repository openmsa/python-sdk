...
class ConfProfile(MSA_API):
    ...
    def __init__(self, profile_id=None, name=None, externalReference=None, comment=None, 
                 vendor_id=None, model_id=None, microserviceUris=[], templateUris=[], 
        ...
        customer_id: Integer
                Customer id which you want to attach a created configuration profile
    ...
    def read(self):
        ...
        self.microserviceUris = list(microserviceUris.keys()) if microserviceUris else []
    ...
    def update(self):
        ...
        self.path = "{}/v2/{}?customer_id={}".format(self.api_path, self.profile_id, self.customer_id)
        data = {
                    "name": self.name,
                    "externalReference": self.externalReference,
                    "comment": self.comment,
